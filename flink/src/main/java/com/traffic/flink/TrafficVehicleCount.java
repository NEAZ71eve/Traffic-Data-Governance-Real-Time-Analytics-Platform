...
public class TrafficVehicleCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        env.getCheckpointConfig().setCheckpointStorage("file:///tmp/flink-checkpoints/traffic-vehicle-count");
        ...
        DataStream<Tuple4<String, Long, Integer, Double>> result = stream
            ...
            .returns(org.apache.flink.api.common.typeinfo.TypeInformation.of(new org.apache.flink.api.common.typeinfo.TypeHint<org.apache.flink.api.java.tuple.Tuple3<String, Long, Integer>>(){}))
    ...
    > {
        ...
        public Tuple3<Long, Integer, Integer> merge(Tuple3<Long, Integer, Integer> a, Tuple3<Long, Integer, Integer> b) {
            return org.apache.flink.api.java.tuple.Tuple3.of(a.f0 + b.f0, a.f1 + b.f1, a.f2 + b.f2);
        }
    }
